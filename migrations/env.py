...
from src.toys.models import Base as ToysBase
...
# target_metadata = [WagonLotsBase.metadata, OptionsBase.metadata, MaterialsBase.metadata]
target_metadata = [ToysBase.metadata]
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            version_table="alembic_version_wagon_lots",
        )
